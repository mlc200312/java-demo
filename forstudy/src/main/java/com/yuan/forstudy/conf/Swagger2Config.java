...
@EnableWebMvc
@EnableSwagger2
@ComponentScan(basePackages = { "com.yuan.forstudy.controller" })
@Configuration
public class Swagger2Config extends WebMvcConfigurerAdapter {
	@Bean
	public Docket createRestApi() {
		return new Docket(DocumentationType.SWAGGER_2).apiInfo(apiInfo()).select().apis(RequestHandlerSelectors.basePackage("com.yuan.forstudy.controller"))
